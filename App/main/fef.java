...
// // g2.fillRect(80, 700-Integer.parseInt(vitaminField.getText()), 20, Integer.parseInt(vitaminField.getText())); //vitamins bar
...
//     public JTextField fruitField=new JTextField("10");
...
//             g.fillRect(30, 200, 20, Integer.parseInt(proteinField.getText())); //protien bar
//             g.fillRect(60, 200, 20, Integer.parseInt(caloriesField.getText())); //calories bar
//             g.fillRect(90, 200, 20, Integer.parseInt(vitaminField.getText())); //vitamins bar
//             g.fillRect(120, 200, 20, Integer.parseInt(fruitField.getText())); //fruits bar
//             g.fillRect(150, 200, 20, Integer.parseInt(vegField.getText())); //veggies bar
//         };
...
//         // //original:
//         // g2.setColor(Color.YELLOW);       // code to draw rectangles goes here...
//         // //suggested protein
//         // // g2.fillRect(0,700,20,)
...
//         //         drawGraphs(); //newly added - attempt to update from the default of "10"
